...
export function TeamCard({ name, role, body, photo }: { name: string; role: string; body?: string; photo?: string }) {
  return (
    <div>
      ...
      {body && <p className="m-0 text-[15px] leading-[1.55] text-ink-soft">{body}</p>}
    </div>
  )
}
